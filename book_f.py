...
inputfilename = 'AMAZON Book_20210418.xlsx'
...
def main(inputfilename, driver):
    ...
    ws = wb[sheet_names[0]]
    all_dict = {"USA":4, "Canada":6, "Brazil":8, "Turkey":10, "Australia":12, "UK":14, "Singapore":16}
    for con in all_dict:
        outputfilename = con
        for i in range(2,ws.max_row): # 1爲編號
            ...
            # print(f"{number},{name},{rec_time},{rating},{ranking},{url},{price}\n")
            with open (f'book_{outputfilename}.csv','a', encoding= 'utf-8') as f:
